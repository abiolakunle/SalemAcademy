    ...
    return (
        <>
            ...
            <Container className='app-primary-sch'>
                ...
                <p> At salem Primary School, we promote excellent all round learning in a very friendly and serene enviroment geared towards building strong minds , with great hearts and true character borne out of the faith, diligence amongst staff and pupils, personal initiatives and enthusian.
                </p>
                <h3>We Promote</h3>
