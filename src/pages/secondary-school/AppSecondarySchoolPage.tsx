...
const AppSecondarySchoolPage = () => {
    return (
        <>
            ...
            <Container className='app-secondary-sch'>
                <p>
                    Salem Secondary School commenced operation in September 2010 with a class of just 10 students, since then , we have grown to be a Centre of Academic Excellence. Our curriculum is a rich blend that challenges learners to brace up to traditional rudiments of the scholarly world such as reading , writing, listening, reasoning and research. It also adopts global perspectives that develops learners' ability to think critically, analytically, systematically and creatively. We teach based on a unique combination of the Nigerian and British Curriculum.
                </p>
                <p>   We teach in accordance to the National Policy of Education (2014), which provides among others for three years of Upper Basic Education (JSS 1-3) with broad-based career-specific subjects consolidated by categories and three years of Senior Secondary Education that culminates in Senior School Ceritificate Examination (SSCE), Unified Tertiary Matriculation Examination (UTME), post-UTME and subsequent admission into tertiary institutions, The Cambridge curriculum culminates in International General Certificate of Secondary Education (IGCSE) and allied examinations - all of which are currently in the pipeline. Our students have been writing Basic Education Certificate Examinations (BECEs) with pass rates in the range of 90 - 100%. The same fear has been recorded with the Senior Secondary Certificate Examination (SSCEs).</p>
